...
function addRandomList() {
  ...
  if (!min || !max || !am) {
    ...
    liElem.style = "font-size: 14px; color: purple; padding: 7px 15px;";
    liElem.textContent = "Введите цифры";
 ...
 document.getElementById("clearButton").onclick = function clear(randomList) { 
  while (randomList.firstChild) {
    randomList.firstChild.remove();
  }
  clear(randomList);
}
